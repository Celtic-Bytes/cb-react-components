...
// Removed Toast import as it is no longer needed
...
export const ToastProvider: FC<ToastProviderProps> = ({ children, id }) => {
   ...
   */
  const addToast = useCallback((toast: Omit<ToastItemProps, 'id'>) => {
  ...
  const groupedToasts: Record<Position, ToastItemProps[]> = {
    'top-start': [],
    'top-center': [],
    'top-end': [],
    'middle-start': [],
